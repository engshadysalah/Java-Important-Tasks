package com.optimal.network.ipadress;
...
/**
 * A helper class provided for Dartmouth's CS 10 -- allows you to easily get
 * your IP address as it is inside/outside your current network.
 *
...
public class MyIPAddressHelper {
    ...
    /**
     * Get your machine's IP address as it is INSIDE of your current network
     * (e.g., Dartmouth's network). Not super robust...
     */
    ...
    /**
     * Get your machine's IP address as it is OUTSIDE of my current network
     * (e.g., Dartmouth's network).
     */
